...
// so Bus Clock (MCLK) is 6 MHz
// baud divisor = MCLK/(16*baudrate)
// baudRate =  2400 bits/sec   SCI0BDL=156
// baudRate =  4800 bits/sec   SCI0BDL=78
// baudRate =  9600 bits/sec   SCI0BDL=39 <------ 0.16% error
...
void SCI_Init(unsigned short baudRate){
  ...
  switch(baudRate){
    ...
    case 9600:  SCI0BDL=39;  break;
    case 14400: SCI0BDL=26;  break;
    case 19200: SCI0BDL=20;  break;
    case 38400: SCI0BDL=10;  break;
    default:    SCI0BDL=26 ;  // 14400 
  }
  SCI0CR1 = 0;
/* bit value meaning
